...
Model: g3-27b-multitask-v1 (Ollama, GGUF Q4_K_M ~17 GB)

Tréning:
    /mnt/tts_data/knihy/train_gemma3_27b_multitask_v1.py
    Train data: 42 655 vzoriek (37K unconstrained + 5K constrained + 0.1K compression)
    LoRA r=16, α=32, 2 epochs, FA2, bf16, train_loss 0.18
...
MODEL_NAME = "g3-27b-multitask-v1"
...
def is_g3_27b_available() -> bool:
    """Skontroluj či ollama beží a g3-27b-multitask-v1 je nahraný."""
    try:
